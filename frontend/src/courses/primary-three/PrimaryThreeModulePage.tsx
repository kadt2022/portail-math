    ...
    <article className={item.kind === "evaluation" ? baseStyles.evaluationCard : baseStyles.lessonCard}>
      ...
      <div className={baseStyles.lessonCopy}>
        ...
        {state ? (
          ...
          <span className={`${baseStyles.status} ${styles.comingSoonStatus}`}>{t("status.coming-soon")}</span>
        )}
      </div>
      {state ? (
...
export function PrimaryThreeModulePage() {
  ...
  return (
    <div className={baseStyles.page}>
      ...
      <section className={baseStyles.lessonSection} aria-labelledby="primary-three-lessons">
        <div className={baseStyles.sectionHeading}>
          <div>
            <p className={baseStyles.eyebrow}>{t("module.pathEyebrow")}</p>
            <h2 id="primary-three-lessons">{t("module.pathTitle")}</h2>
          </div>
